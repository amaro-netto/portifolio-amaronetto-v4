    ...
    <section id="inicio" className="section-snap relative bg-gradient-hero dark:bg-secondary overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 h-full">
        <div className="flex flex-col lg:flex-row items-center justify-between h-full py-20">
          {/* Image Side - Left */}
          <div className="flex-1 flex justify-center lg:justify-end mb-12 lg:mb-0 lg:pr-12 order-1 lg:order-1 self-stretch">
            <div className="relative h-full w-full max-w-md">
              ...
              <img
                ...
                className="relative w-full h-full object-cover rounded-2xl shadow-xl transform hover:scale-105 transition-transform duration-300 object-top"
                loading="eager"
              />
            </div>
          </div>
